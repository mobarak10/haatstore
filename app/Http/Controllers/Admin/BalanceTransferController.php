...
class BalanceTransferController extends Controller
{
    ...
    {
        $transactions = BalanceTransfer::orderBy('id', 'desc')->paginate(15);
        return view('admin.bank.transfer.index', compact('transactions'))->with($this->meta);
    }
    ...
    public function create()
    {
        ...
        return view('admin.bank.transfer.create', compact('cashes', 'banks'))->with($this->meta);
    }
