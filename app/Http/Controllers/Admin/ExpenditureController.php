...
class ExpenditureController extends Controller {
    ...
    public function index() {
        ...
        $subtotal = Expenditure::whereBetween('date', [$first, $last])->get()->groupBy('date')->map(function ($row){
        ...
        if(request()->search) {
            ...
            $subtotal = Expenditure::whereBetween('date', [$from, $to])->get()->groupBy('date')->map(function ($row) {
                return $row->sum('amount');
            });
        }

        // view
        return view('admin.expenditure.index', compact('subtotal'))->with($this->meta);
    }
    ...
    public function create() {
        ...
        $glAccounts = GlAccount::where('business_id', $user)->get();
        $cashes = Cash::where('business_id', $user)->get();
        $banks = Bank::where('business_id', $user)->get();

        return view('admin.expenditure.create', compact('glAccounts', 'cashes', 'banks'))->with($this->meta);
    }
    ...
    public function show($date) {
        ...
        return view('admin.expenditure.show', compact('expenditures', 'date'))->with($this->meta);
    }
    ...
    public function edit($id) {
        ...
        return view('admin.expenditure.edit', compact('expenditure', 'glAccounts'))->with($this->meta);
    }
