...
@section('content')
    <div class="container">
        {{--<div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header" data-toggle="collapse" data-target="#product-search-form">
                        <div class="row">
                            <div class="col-6">
                                Search Products
                            </div>
                            <div class="col-6 text-right">
                                <button class="btn btn-sm btn-primary" type="button" data-toggle="collapse" data-target="#product-search-form">
                    ...
                    <div class="collapse {{ (Route::currentRouteName() == 'product.search') ? 'show' : '' }}" id="product-search-form">
                        <div class="card-body">
                            <form action="{{ route('product.search') }}" method="GET">
                                <product-search-company-brand-category :suppliers="{{ $suppliers }}"
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" name="code" class="form-control" id="code" value="{{ $searched_query['code'] ?? '' }}" placeholder="PRDXXXX">
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        <label>&nbsp;</label>
