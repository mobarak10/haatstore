    ...
    <div class="pos-categories">
        ...
        <div class="row mx-n2">
            ...
            >
                <!-- Single -->
                <div
                    class="single border mb-3"
                    :class="{
                        active: productFilter.categoryId === category.id
                    }"
                >
                    <a
                        href="#"
            ...
            <div class="col-6 col-lg-2 col-sm-3 px-2">
                ...
                <div
                    class="single border mb-3"
                    :class="{ active: productFilter.categoryId === null }"
                >
                    <a
                        href="#"
...
export default {
    ...
    computed: {
        ...mapState(["activeCategories", "productFilter"])
    },
    methods: {
        ...mapActions(["actionLoadActiveCategories"]),
        ...mapMutations(["mutationProductFilters"]),
