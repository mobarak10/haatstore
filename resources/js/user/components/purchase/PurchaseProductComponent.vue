                    ...
                    <div class="form-row" v-if="cartContents.length !== 0">
                        <div class="col-sm-12">
                            <table class="table table-bordered table-sm table-responsive-md">
                                ...
                                <tr>
                                    <td class="text-right" colspan="6"><label for="discount">Adjustment</label></td>
                                    <td class="text-right">
                    ...
                    <div class="modal-body" v-if="quantityModalData">
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div class="input-group">
                                    <input type="number" v-model="quantityModalData.wholesale_price" step="any"
                                           class="form-control" id="wholesale-price"
    ...
    watch: {
        ...
        barcode: {
            handler: function (barcode) {
                if (barcode){
                    this.product = this.products.find(product => product.barcode === barcode)
